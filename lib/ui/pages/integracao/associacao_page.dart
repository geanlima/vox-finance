  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            'Escolha o que deseja configurar. As associações são usadas na sincronização com a API.',
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Relacione os cartões da API com os cartões cadastrados no aplicativo.',
